...
function NavbarLayout1(props) {
	...
	return (
		<div className={clsx('flex flex-col overflow-hidden h-full', classes.root, props.className)}>
			...
			<NavbarMobileToggleButton variant="contained" color="Primary">
			<Link to="/UserManager" className="btn btn-lg btn-info mr-2">
			User Management
                </Link>
			{/* <Route exact path="/UserManager" component={UserManager} />User Management */}
			</NavbarMobileToggleButton>
		</div>
	);
}
